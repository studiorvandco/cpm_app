...
class _LocationsState extends State<Locations> {
    ...
    if (edited is Location) {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
            PopupSnackBar().getEditedModelSnackBar(context, result[0] as bool, result[1] as int, location));
      }
    }
  }
  ...
  Future<void> deleteLocation(Location location) async {
    ...
    if (context.mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          PopupSnackBar().getDeletedModelSnackBar(context, result[0] as bool, result[1] as int, location));
    }
  }
    ...
    if (location is Location) {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context)
            .showSnackBar(PopupSnackBar().getNewModelSnackBar(context, result[0] as bool, result[1] as int, location));
      }
      setState(() {
        getLocations();
      });
