...
class _SettingsState extends ConsumerState<Settings> {
  ...
  Widget build(BuildContext context) {
    return ref.watch(themeProvider).when(data: (ThemeMode theme) {
      return Expanded(
              ...
              children: <Widget>[
                SizedBox(
                  ...
                  child: Column(
                    children: <Widget>[
                      Radio<ThemeMode>(
                          value: ThemeMode.light, groupValue: theme, onChanged: (ThemeMode? mode) => setTheme(mode)),
                ...
                SizedBox(
                  ...
                  child: Column(
                    children: <Widget>[
                      Radio<ThemeMode>(
                          value: ThemeMode.dark, groupValue: theme, onChanged: (ThemeMode? mode) => setTheme(mode)),
                ...
                SizedBox(
                  ...
                  child: Column(
                    children: <Widget>[
                      Radio<ThemeMode>(
                          value: ThemeMode.system, groupValue: theme, onChanged: (ThemeMode? mode) => setTheme(mode)),
