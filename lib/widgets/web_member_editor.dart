...
class WebMemberEditor extends StatelessWidget {
  ...
  Widget _getPicture() {
    return picture == null
        ? const Center(child: Padding(padding: EdgeInsets.all(16), child: Icon(Icons.camera_alt)))
        : picture!;
  }
          ...
          child: Column(
            children: <Widget>[
                      ...
                      Material(
                        ...
                        child: InkWell(
                          ...
                          overlayColor: MaterialStateColor.resolveWith(
                            (Set<MaterialState> states) => Theme.of(context).colorScheme.tertiary.withOpacity(0.08),
                          ),
                        ),
                      ),
                    ],
              ...
              TextFormField(
                initialValue: phone,
                decoration:
                    const InputDecoration(labelText: 'Phone number', border: OutlineInputBorder(), isDense: true),
              ),
              const SizedBox(
                height: 32,
              ),
